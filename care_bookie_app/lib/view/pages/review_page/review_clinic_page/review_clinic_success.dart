...
class ReviewClinicSuccess extends StatefulWidget {
  ...
  @override
  State<ReviewClinicSuccess> createState() => _ReviewClinicState();
}

class _ReviewClinicState extends State<ReviewClinicSuccess> {
  @override
          ...
          child: Row(
            children: [
              Column(
                ...
                children: [
                  Text(
                    "${historyDetailPageViewModel.hospitalDetail!.star}",
                  ...
                  Row(
                    children: [
                      RatingBarIndicator(
                        rating: historyDetailPageViewModel.hospitalDetail!.star.toDouble(),
              ...
              Column(
                ...
                children: [
                  Text(
                    "${historyDetailPageViewModel.listCommentHospital.length}",
                    style: const TextStyle(
                        fontSize: 30,
                        fontWeight: FontWeight.w500,
                        fontFamily: 'Poppins',
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(
                              historyDetailPageViewModel.hospitalDetail!.image,
  ...
  Widget commentsClinic() {
    ...
    return Column(
      children: [
        ...historyDetailPageViewModel.listCommentHospital.map((comment) => Container(
