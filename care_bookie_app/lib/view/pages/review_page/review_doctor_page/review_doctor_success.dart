...
class ReviewDoctorSuccess extends StatefulWidget {
  const ReviewDoctorSuccess({Key? key}) : super(key: key);

  @override
  State<ReviewDoctorSuccess> createState() => _ReviewDoctorState();
}

class _ReviewDoctorState extends State<ReviewDoctorSuccess> {
  @override
          ...
          child: Row(
            children: [
              Column(
                ...
                children: [
                  Text(
                    "${historyDetailPageViewModel.doctorDetail!.star}",
                  ...
                  Row(
                    children: [
                      RatingBarIndicator(
                        rating: historyDetailPageViewModel.doctorDetail!.star.toDouble(),
              ...
              Column(
                ...
                children: [
                  Text(
                    "${historyDetailPageViewModel.listCommentDoctor.length}",
                    style: const TextStyle(
                        fontSize: 30,
                        fontWeight: FontWeight.w500,
                        fontFamily: 'Poppins',
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(
                              historyDetailPageViewModel.doctorDetail!.image,
  ...
  Widget commentsDoctor() {
    ...
    return Column(
      children: [
        ...historyDetailPageViewModel.listCommentDoctor.map((comment) => Container(
