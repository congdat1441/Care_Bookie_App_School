      ...
      builder: (context, homePageViewModel, child) => SizedBox(
        ...
        homePageViewModel.hospitals.isEmpty
          ...
          children: [
            ...
            ...homePageViewModel.hospitals.map((hospital) => Padding(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () async{
                          ...
                          hospitalDetailPageProvider.setHospitalDetail(hospital);
                          ...
                          await hospitalDetailPageProvider.getAllDoctorByHospitalId(hospital.id);
