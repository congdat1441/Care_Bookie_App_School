...
class DoctorApi {
  Future<List<Doctor>> getAllDoctorApi() async {
    String url =
        "https://3c1e-117-2-6-32.ngrok-free.app/api/v1/care-bookie/common/doctor/getAll";
  ...
  Future<List<Comment>> getAllCommentByDoctorIdApi(String doctorId) async {
    String url =
        "https://3c1e-117-2-6-32.ngrok-free.app/api/v1/care-bookie/common/doctor/comment/$doctorId";
  ...
  Future<bool> createFavoriteDoctorApi(String doctorId, String userId) async {
    String url =
        "https://3c1e-117-2-6-32.ngrok-free.app/api/v1/care-bookie/user/doctor/favourite/$userId?doctorId=$doctorId";
